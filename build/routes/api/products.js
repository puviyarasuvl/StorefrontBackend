...
productRouter.post('/', roleValidator_1.default, authenticator_1.default, function (req, res) {
    create(req, res);
});
...
productRouter.delete('/', roleValidator_1.default, authenticator_1.default, function (req, res) {
