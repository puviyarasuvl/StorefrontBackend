...
var currentOrder = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, customerDashboard.currentOrder(res.locals.userId)];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
...
var completedOrders = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, customerDashboard.completedOrders(res.locals.userId)];
            case 1:
                result = _a.sent();
                res.send(result);
                return [3 /*break*/, 3];
...
dashboardRouter.get('/cart', authenticator_1.default, userIdGetter_1.default, function (req, res) {
    currentOrder(req, res);
});
dashboardRouter.get('/orders', authenticator_1.default, userIdGetter_1.default, function (req, res) {
